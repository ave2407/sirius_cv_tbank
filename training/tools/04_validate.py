...
ap.add_argument("--data", default="data/merged_tlogo/data.yaml")
...
with open(args.out, "w", encoding="utf-8") as f:
    json.dump(dict(split=args.split, conf=args.conf, iou=args.iou, imgsz=args.imgsz, **metrics), f, indent=4,
              ensure_ascii=False)
